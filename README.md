...
- **Every non-obvious choice has an ADR** — 26 so far, in `docs/decisions/`. <!-- check:adrs -->
...
Currently 9 ingestion sources, 12 dbt models and 26 ADRs. <!-- check:sources check:dbt_models check:adrs -->
